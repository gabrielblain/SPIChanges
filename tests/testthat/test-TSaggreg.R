...
test_that("TS not a number", {
  expect_error(
    tes <- TSaggreg(daily.rain=daily.rain,start.date="1991-01-01",TS="quatro"),
...
test_that("TS lower than 1", {
  expect_error(
    tes <- TSaggreg(daily.rain=daily.rain,start.date="1991-01-01",TS=0),
    "TS must be an interger single number between 1 and 96")
})
...
test_that("TS larger than 96", {
  expect_error(
    tes <- TSaggreg(daily.rain=daily.rain,start.date="1991-01-01",TS=97),
    "TS must be an interger single number between 1 and 96")
})
...
test_that("TS wrong format", {
  expect_error(
    tes <- TSaggreg(daily.rain=daily.rain,start.date="1991-01-01",TS=c(2,97)),
    "TS must be an interger single number between 1 and 96")
})
